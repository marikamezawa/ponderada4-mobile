...
final growthLogDatasourceProvider = Provider<SqliteGrowthLogDatasource>(
  (_) => SqliteGrowthLogDatasource(),
);
...
class GrowthLogNotifier extends FamilyAsyncNotifier<List<GrowthLog>, String> {
  @override
  ...
  Future<void> addLog({
    ...
    state.whenData((logs) => state = AsyncData([...logs, saved]));
  }
...
final growthLogProvider =
    AsyncNotifierProviderFamily<GrowthLogNotifier, List<GrowthLog>, String>(
      () => GrowthLogNotifier(),
    );
